...
class ABSL_DLL  StderrLogSink final : public LogSink {
 public:
...
class ABSL_DLL  AndroidLogSink final : public LogSink {
 public:
...
#if defined(_WIN32)
class ABSL_DLL  WindowsDebuggerLogSink final : public LogSink {
 public:
...
class ABSL_DLL  GlobalLogSinkSet final {
 public:
  GlobalLogSinkSet() {
