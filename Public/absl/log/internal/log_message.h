...
class ABSL_DLL  ABSL_DLL LogMessage {
 public:
  struct InfoTag {};
  struct WarningTag {};
  struct ErrorTag {};
 ...
 private:
  ...
  class ABSL_DLL  OstreamView final : public std::streambuf {
   public:
  ...
  ABSL_DLL enum class  StringType {
    kLiteral,
    kNotLiteral,
  };
...
class ABSL_DLL  StringifySink final {
 public:
...
// message.
class ABSL_DLL  LogMessageFatal final : public LogMessage {
 public:
...
class ABSL_DLL  LogMessageDebugFatal final : public LogMessage {
 public:
  LogMessageDebugFatal(const char* file, int line) ABSL_ATTRIBUTE_COLD;
  ~LogMessageDebugFatal();
};

class ABSL_DLL  LogMessageQuietlyDebugFatal final : public LogMessage {
 public:
...
class ABSL_DLL  LogMessageQuietlyFatal final : public LogMessage {
 public:
