...
ABSL_DLL enum class  FlagHelpKind : uint8_t { kLiteral = 0, kGenFunc = 1 };
...
ABSL_DLL enum class  FlagDefaultKind : uint8_t {
  kDynamicValue = 0,
  kGenFunc = 1,
...
ABSL_DLL enum class  FlagValueStorageKind : uint8_t {
  kValueAndInitBit = 0,
  kOneWordAtomic = 1,
  kSequenceLocked = 2,
  kAlignedBuffer = 3,
...
#endif
class ABSL_DLL  FlagImpl final : public CommandLineFlag {
 public:
