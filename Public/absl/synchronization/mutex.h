...
class ABSL_DLL  ABSL_LOCKABLE Mutex {
 public:
...
//   Mutex mu_;
// };
class ABSL_DLL  ABSL_SCOPED_LOCKABLE MutexLock {
 public:
  // Constructors
...
class ABSL_DLL  ABSL_SCOPED_LOCKABLE ReaderMutexLock {
 public:
...
class ABSL_DLL  ABSL_SCOPED_LOCKABLE WriterMutexLock {
 public:
...
class ABSL_DLL  ABSL_SCOPED_LOCKABLE MutexLockMaybe {
 public:
...
class ABSL_DLL  ABSL_SCOPED_LOCKABLE ReleasableMutexLock {
 public:
...
ABSL_DLL enum class  OnDeadlockCycle {
