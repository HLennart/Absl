...
class ABSL_DLL  FileZoneInfoSource : public ZoneInfoSource {
 public:
...
class ABSL_DLL  AndroidZoneInfoSource : public FileZoneInfoSource {
 public:
  static std::unique_ptr<ZoneInfoSource> Open(const std::string& name);
...
class ABSL_DLL  FuchsiaZoneInfoSource : public FileZoneInfoSource {
 public:
  static std::unique_ptr<ZoneInfoSource> Open(const std::string& name);
  std::string Version() const override { return version_; }
