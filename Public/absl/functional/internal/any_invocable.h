...
ABSL_DLL enum class  FunctionToCall : bool { relocate_from_to, dispose };
...
template <class Sig>
class ABSL_DLL  Impl {};  // Note: This is partially-specialized later.

// A std::unique_ptr deleter that deletes memory allocated via ::operator new.
#if defined(__cpp_sized_deallocation)
class ABSL_DLL  TrivialDeleter {
 public:
