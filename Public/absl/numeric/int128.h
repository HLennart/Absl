...
namespace std {
template <>
class ABSL_DLL  numeric_limits<absl::uint128> {
 public:
...
namespace std {
template <>
class ABSL_DLL  numeric_limits<absl::int128> {
 public:
  static constexpr bool is_specialized = true;
...
int128 ABSL_DLL operator/(int128 lhs, int128 rhs);
int128 ABSL_DLL operator%(int128 lhs, int128 rhs);
constexpr int128 operator|(int128 lhs, int128 rhs);
constexpr int128 operator&(int128 lhs, int128 rhs);
constexpr int128 operator^(int128 lhs, int128 rhs);
...
#if defined(ABSL_HAVE_INTRINSIC_INT128)
#include "absl/numeric/int128_have_intrinsic.h"  // IWYU pragma: export
#else  // ABSL_HAVE_INTRINSIC_INT128
#include "absl/numeric/int128_no_intrinsic.h"  // IWYU pragma: export
#endif  // ABSL_HAVE_INTRINSIC_INT128
