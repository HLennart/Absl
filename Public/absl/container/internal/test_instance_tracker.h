...
class ABSL_DLL  BaseCountedInstance {
 public:
...
class ABSL_DLL  InstanceTracker {
 public:
  InstanceTracker()
...
class ABSL_DLL  CopyableOnlyInstance : public BaseCountedInstance {
 public:
...
class ABSL_DLL  CopyableMovableInstance : public BaseCountedInstance {
 public:
...
class ABSL_DLL  MovableOnlyInstance : public BaseCountedInstance {
 public:
