...
class ABSL_DLL  map_value_compare {
...
ABSL_DLL enum class  MatchKind : uint8_t { kEq, kNe };
...
class ABSL_DLL  btree_iterator_generation_info_enabled {
 public:
...
class ABSL_DLL  btree_iterator_generation_info_disabled {
 public:
...
class ABSL_DLL  btree_iterator : private btree_iterator_generation_info {
