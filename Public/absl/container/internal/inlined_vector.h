...
class ABSL_DLL  IteratorValueAdapter {
 public:
...
template <typename A>
class ABSL_DLL  CopyValueAdapter {
 public:
...
template <typename A>
class ABSL_DLL  DefaultValueAdapter {
 public:
...
template <typename A>
class ABSL_DLL  AllocationTransaction {
 public:
...
template <typename A>
class ABSL_DLL  ConstructionTransaction {
 public:
