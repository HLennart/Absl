...
class ABSL_DLL  NonIterableBitMask {
 public:
...
class ABSL_DLL  BitMask : public NonIterableBitMask<T, SignificantBits, Shift> {
...
ABSL_DLL enum class  ctrl_t : int8_t {
...
class ABSL_DLL  CommonFieldsGenerationInfoEnabled {
...
class ABSL_DLL  CommonFieldsGenerationInfoDisabled {
 public:
...
class ABSL_DLL  HashSetIteratorGenerationInfoEnabled {
 public:
...
class ABSL_DLL  HashSetIteratorGenerationInfoDisabled {
 public:
...
class ABSL_DLL  RawHashSetLayout {
 public:
...
class ABSL_DLL  CommonFields : public CommonFieldsGenerationInfo {
 public:
...
class ABSL_DLL  raw_hash_set {
 ...
 public:
  ...
  class ABSL_DLL  iterator : private HashSetIteratorGenerationInfo {
