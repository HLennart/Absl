...
class ABSL_DLL btree_container {
...
template <typename Tree>
class ABSL_DLL btree_set_container : public btree_container<Tree> {
...
template <typename Tree>
class ABSL_DLL btree_map_container : public btree_set_container<Tree> {
...
template <typename Tree>
class ABSL_DLL btree_multiset_container : public btree_container<Tree> {
  using super_type = btree_container<Tree>;
  using params_type = typename Tree::params_type;
  using init_type = typename params_type::init_type;
  using is_key_compare_to = typename params_type::is_key_compare_to;
...
template <typename Tree>
class ABSL_DLL btree_multimap_container : public btree_multiset_container<Tree> {
