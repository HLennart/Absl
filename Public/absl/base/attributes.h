...
// returns an instance.
//
//   class ABSL_DLL  ABSL_MUST_USE_RESULT Sprocket {};
...
// Examples:
//
//   class ABSL_DLL  ABSL_DEPRECATED("Use Bar instead") Foo {...};
//
...
// For example:
//
// class ABSL_DLL  ABSL_ATTRIBUTE_WARN_UNUSED MyType {
//  public:
//   MyType();
//   ~MyType();
// };
