...
class ABSL_DLL  TestBadAllocException : public std::bad_alloc, public TestException {
 public:
...
class ABSL_DLL  ConstructorTracker {
 public:
...
class ABSL_DLL  ThrowingValue : private exceptions_internal::TrackedObject {
...
class ABSL_DLL  ThrowingAllocator : private exceptions_internal::TrackedObject {
...
template <typename T>
class ABSL_DLL  ExceptionSafetyTest {
...
class ABSL_DLL  ExceptionSafetyTestBuilder {
 public:
  /*
