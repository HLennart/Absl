...
class ABSL_DLL  OnlyLiteralZero {
 public:
...
ABSL_DLL enum class  eq : value_type {
  equal = 0,
  equivalent = equal,
  nonequal = 1,
...
ABSL_DLL enum class  ord : value_type { less = -1, greater = 1 };

ABSL_DLL enum class  ncmp : value_type { unordered = -127 };
