...
template <class H, class... T>
class ABSL_DLL  VariantStateBase {
 protected:
...
template <class... T>
class ABSL_DLL  VariantStateBaseDestructorNontrivial : protected VariantStateBase<T...> {
 private:
...
template <class... T>
class ABSL_DLL  VariantMoveBaseNontrivial : protected VariantStateBaseDestructor<T...> {
 private:
...
template <class... T>
class ABSL_DLL  VariantCopyBaseNontrivial : protected VariantMoveBase<T...> {
 private:
...
template <class... T>
class ABSL_DLL  VariantMoveAssignBaseNontrivial : protected VariantCopyBase<T...> {
...
template <class... T>
class ABSL_DLL  VariantCopyAssignBaseNontrivial : protected VariantMoveAssignBase<T...> {
  friend struct VariantCoreAccess;
