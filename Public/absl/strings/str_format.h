...
class ABSL_DLL  UntypedFormatSpec {
 public:
...
//   EXPECT_EQ(8, n);
class ABSL_DLL  FormatCountCapture {
 public:
...
// passed to `StrFormat()`.
ABSL_DLL enum class  FormatConversionChar : uint8_t {
  c, s,                    // text
  d, i, o, u, x, X,        // int
...
class ABSL_DLL  FormatConversionSpec {
 public:
...
ABSL_DLL enum class  FormatConversionCharSet : uint64_t {
  // text
