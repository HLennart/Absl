...
ABSL_DLL enum class  LengthMod : std::uint8_t { h, hh, l, ll, L, j, z, t, q, none };

namespace str_format_internal {

class ABSL_DLL  FormatRawSinkImpl {
 public:
...
ABSL_DLL enum class  Flags : uint8_t {
  kBasic = 0,
  kLeft = 1 << 0,
  kShowPos = 1 << 1,
  kSignCol = 1 << 2,
...
struct FormatConversionCharInternal {
 ...
 private:
  // clang-format off
  ABSL_DLL enum class  Enum : uint8_t {
    c, s,                    // text
    d, i, o, u, x, X,        // int
...
class ABSL_DLL  FormatConversionSpecImpl {
 public:
