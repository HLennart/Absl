...
class ABSL_DLL  BoundConversion : public FormatConversionSpecImpl {
 public:
...
class ABSL_DLL  UntypedFormatSpecImpl {
 public:
...
// by std::ostream << v.
template <typename T>
class ABSL_DLL  StreamedWrapper {
 public:
