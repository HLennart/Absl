...
class ABSL_DLL  CrcMemcpyEngine {
 public:
...
class ABSL_DLL  FallbackCrcMemcpyEngine : public CrcMemcpyEngine {
 public:
...
class ABSL_DLL  CrcNonTemporalMemcpyEngine : public CrcMemcpyEngine {
 public:
...
class ABSL_DLL  CrcNonTemporalMemcpyAVXEngine : public CrcMemcpyEngine {
 public:
