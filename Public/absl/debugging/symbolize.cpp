...
#include "absl/debugging/symbolize_elf.h"
#elif defined(ABSL_INTERNAL_HAVE_SYMBOLIZE_WIN32)
// The Windows Symbolizer only works if PDB files containing the debug info
// are available to the program at runtime.
#include "absl/debugging/symbolize_win32.h"
#elif defined(__APPLE__)
#include "absl/debugging/symbolize_darwin.h"
#elif defined(ABSL_INTERNAL_HAVE_SYMBOLIZE_WASM)
#include "absl/debugging/symbolize_emscripten.h"
#else
#include "absl/debugging/symbolize_unimplemented.h"
#endif
